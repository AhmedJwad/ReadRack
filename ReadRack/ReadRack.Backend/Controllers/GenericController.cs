...
namespace ReadRack.Backend.Controllers
{
    ...
    public class GenericController<T> : Controller where T : class
    {
        ...
        public virtual async Task<IActionResult> GetRecordsNumberAsync([FromQuery] PaginationDTO paginationDTO)
        {
            var response=await _genericUnitOfWork.GetRecordsNumberAsync(paginationDTO);
